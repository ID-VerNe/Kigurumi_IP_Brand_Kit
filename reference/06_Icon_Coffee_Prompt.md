# 06_Icon_Coffee 提示词档案 (Prompt Reference)
...
Background: fill the entire square with solid gently muted warm latte orange.
Subject: place one extremely simplified, cute, endearing girl IP character perfectly centered and upright, emerging from the bottom edge. To represent a Productivity/Life app, she is holding an oversized cute geometric coffee mug.
