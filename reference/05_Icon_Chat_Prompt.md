# 05_Icon_Chat 提示词档案 (Prompt Reference)
...
Background: fill the entire square with solid gently muted sky cyan.
Subject: place one extremely simplified, cute, endearing girl IP character perfectly centered and upright, emerging from the bottom edge. To represent a Social Chat app, she is holding a large, pure geometric speech bubble.
