# 01_Icon_Tools 提示词档案 (Prompt Reference)
...
Background: fill the entire square with solid gently muted tech blue.
Subject: place one extremely simplified, cute, endearing girl IP character perfectly centered and upright, emerging from the bottom edge. To represent a Tools/Utility app, she is holding a large, pure geometric wrench.
