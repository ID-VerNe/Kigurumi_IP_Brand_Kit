# 04_Icon_Game 提示词档案 (Prompt Reference)
...
Background: fill the entire square with solid gently muted vibrant purple.
Subject: place one extremely simplified, cute, endearing girl IP character perfectly centered and upright, emerging from the bottom edge. To represent a Gaming app, she is holding a large, pure geometric retro cross D-pad game controller.
