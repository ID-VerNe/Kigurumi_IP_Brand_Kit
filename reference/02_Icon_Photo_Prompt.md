# 02_Icon_Photo 提示词档案 (Prompt Reference)
...
Background: fill the entire square with solid gently muted warm yellow.
Subject: place one extremely simplified, cute, endearing girl IP character perfectly centered and upright, emerging from the bottom edge. To represent a Photo/Gallery app, she is holding a large, pure geometric cute little camera.
